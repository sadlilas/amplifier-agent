"""Tests for admin/cache_clear.py — wiring cache clear to remove XDG prepared cache."""
...
def test_clear_cache_removes_xdg_dir(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
